...
const char * tokenTypeStr[] = {"tKEYWORD","tSYMBOL","tIDENTIFIER","tINT_CONST","tSTRING_CONST","tUNKNOWN"};
...
// le o diretorio
	...
	//cout << jack->isKeyword("let");

	while (jack->hasMoreTokens()){
		jack->advance();
		//cout << "token:"<< jack->currentToken << "-- " << tokenTypeStr[jack->tokenType()] << jack->tokenType() << endl;
		cout << jack->tagToken() << endl;
